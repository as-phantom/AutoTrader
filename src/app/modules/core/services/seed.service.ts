    ...
    Promise.all(
      regions.map(
        (name) =>
          ...
          }) as Promise<{ data: { createRegion: Region } }>
      )
    )
      .then(console.log)
      .catch(console.error);
